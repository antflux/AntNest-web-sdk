"use strict";
/*
Antnest Adapter Library for Google Analytics
*/
(function () {
    // logs array for tests
    window.cly_ga_test_logs = [];
    // adapter function
    window.AntnestGAAdapter = function () {
        // hold ga instance
        ...
        var ga_countly = function() {
            gaAntnestArray.push(arguments);
        };

        // when countly initialized
        Antnest.onload.push(function () {
            // cart for ga:ecommerce plugin
            var cart = Antnest._internals.store('cly_ecommerce:cart') || [];
                    ...
                    switch (c) {
                        case 'send':
                            if (typeof o === 'string') {
                                ...
                                // ga('send', 'pageview')
                                    ...
                                    if (Antnest._internals.store('cly_ga:page')) {
                                        Antnest.q.push(['track_pageview', Antnest._internals.store('cly_ga:page')]);
                                        if (window.cly_ga_test_mode) window.cly_ga_test_logs.push(['track_pageview', Antnest._internals.store('cly_ga:page')]);
                                    }
                                    else {
                                ...
                                // ga('send', 'pageview', 'page')
                                    ...
                                    Antnest.q.push(['track_pageview', arguments[2]]);
                                ...
                                // ga('send', 'screenview', {..})
                                    ...
                                    if (Antnest._internals.store('cly_ga:screenname')) customSegments.screenName = Antnest._internals.store('cly_ga:screenname');
                                ...
                                // ga('send', 'exception', {..})
                                    ...
                                    Antnest.log_error(u.exDescription);
                            ...
                            // ga('send', {hitType:.., ...})
                                ...
                                switch (o.hitType) {
                                    ...
                                    case 'pageview':
                                        Antnest.q.push(['track_pageview', o.page]);
                                        if (window.cly_ga_test_mode) {
                        ...
                        case 'create':
                            ...
                            if (arguments.length === 4 && arguments[2] === 'auto') {
                                Antnest._internals.store('cly_ga:id', o);
                                if (window.cly_ga_test_mode) {
                                    window.cly_ga_test_logs.push({
                                        'stored': Antnest._internals.store('cly_ga:id'),
                                        'value': o
                                    });
                                }
                        ...
                        case 'set':
                            ...
                            if (o === 'page') {
                                Antnest._internals.store('cly_ga:page', u);
                            }
                            // ga('set', 'screenname', 'High scores')
                            else if (o === 'screenname') {
                                Antnest._internals.store('cly_ga:screenname', u);
                                if (window.cly_ga_test_mode) {
                                    window.cly_ga_test_logs.push({
                                        'stored': Antnest._internals.store('cly_ga:screenname'),
                                        'value': u
                                    });
                                }
                            }
                            // ga('set', 'dimension', 'custom data')
                                ...
                                Antnest.q.push(['userData.set', o, u]);
                                if (window.cly_ga_test_mode) {
                            ...
                            // ga('set', {key:val, anotherKey: anotherVal})
                                ...
                                Antnest.q.push(['user_details', {custom: o}]);
                                if (window.cly_ga_test_mode) {
                        ...
                        case 'ecommerce:addItem':
                            ...
                            Antnest._internals.store('cly_ecommerce:cart', cart);
                        ...
                        case 'ecommerce:clear':
                            ...
                            if (window.cly_ga_test_mode) {
                                window.cly_ga_test_logs.push(Antnest._internals.store('cly_ecommerce:cart'));
                            }
                            break;
                        default:
                            break;
            ...
            while(gaAntnestArray.length) {
                var args = gaAntnestArray.shift();
